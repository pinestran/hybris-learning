 ...
 */
package de.hybris.learning.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(HybrislearningFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(HybrislearningFulfilmentProcessConstants.PARENT_PROCESS);
