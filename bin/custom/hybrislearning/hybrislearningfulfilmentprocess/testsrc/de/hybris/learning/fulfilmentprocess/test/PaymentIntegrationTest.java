...
import de.hybris.learning.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/hybrislearningfulfilmentprocess/test/hybrislearningfulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/hybrislearningfulfilmentprocess/test/hybrislearningfulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/hybrislearningfulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/hybrislearningfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/hybrislearningfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/hybrislearningfulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/hybrislearningfulfilmentprocess/test/hybrislearningfulfilmentprocess-spring-testcleanup.xml"));
