 ...
 */
package de.hybris.learning.fulfilmentprocess.test.jobs;
...
import de.hybris.learning.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = HybrislearningFulfilmentProcessConstants.ORDER_PROCESS_NAME;
