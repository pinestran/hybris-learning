 ...
 */
package de.hybris.learning.test.setup;
...
import de.hybris.learning.test.constants.HybrislearningTestConstants;
import de.hybris.learning.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = HybrislearningTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/hybrislearningtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/hybrislearningtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/hybrislearningtest/import/cstickets.impex");
			...
			importImpexFile(context, "/hybrislearningtest/import/csquotes.impex");
		}
	}
}
