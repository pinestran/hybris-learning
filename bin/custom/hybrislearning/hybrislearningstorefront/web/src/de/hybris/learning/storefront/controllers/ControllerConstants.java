 ...
 */
package de.hybris.learning.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String FeedbackComponent = _Prefix + FeedbackComponentModel._TYPECODE + _Suffix; // NOSONAR
			String YoutubeVideoComponent = _Prefix + YoutubeVideoComponentModel._TYPECODE + _Suffix; // NOSONAR
		}
	}
