...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hybrislearningstorefront/electronics/en",
						"https://electronics.local:9002/hybrislearningstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hybrislearningstorefront/electronics/en",
						"https://electronics.local:9002/hybrislearningstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hybrislearningstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/hybrislearningstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hybrislearningstorefront/electronics/en",
						"https://electronics.local:9002/hybrislearningstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hybrislearningstorefront",
						"https://electronics.local:9002/hybrislearningstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hybrislearningstorefront",
						"https://electronics.local:9002/hybrislearningstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/hybrislearningstorefront/electronics/en",
						"https://electronics.local:9002/hybrislearningstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
