...
/**
 * Global class for all HybrislearningCore constants. You can add global constants for your extension into this class.
 */
public final class HybrislearningCoreConstants extends GeneratedHybrislearningCoreConstants
{
	public static final String EXTENSIONNAME = "hybrislearningcore";


	private HybrislearningCoreConstants()
	{
		//empty
	}
