 ...
 */
package de.hybris.learning.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.learning.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "hybrislearningcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "hybrislearningcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "hybrislearningcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "hybrislearningcommercewebservices.v2.description";
	private static final String TITLE = "hybrislearningcommercewebservices.v2.title";
	private static final String VERSION = "hybrislearningcommercewebservices.v2.version";
	private static final String LICENSE = "hybrislearningcommercewebservices.v2.license";
	private static final String LICENSE_URL = "hybrislearningcommercewebservices.v2.license.url";
