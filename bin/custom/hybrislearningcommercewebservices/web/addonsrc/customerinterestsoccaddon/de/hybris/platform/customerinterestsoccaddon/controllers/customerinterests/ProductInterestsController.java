...
public class ProductInterestsController
{
	...
	public CustomerInterestsSearchPageWsDTO getProductInterests(final HttpServletRequest request,
			...
			@ApiParam(value = "Response configuration. This is the list of fields that should be returned in the response body.", allowableValues = "BASIC, DEFAULT, FULL") @RequestParam(defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
		...
		return dataMapper.map(paginatedData, CustomerInterestsSearchPageWsDTO.class, fields);
	}
