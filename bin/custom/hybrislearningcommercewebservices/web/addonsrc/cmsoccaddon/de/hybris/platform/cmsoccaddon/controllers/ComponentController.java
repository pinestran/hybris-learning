...
public class ComponentController
{
	...
	@ResponseBody
	@ApiOperation(value = "Get component data", notes = "Given a component identifier, return cms component data.", nickname = "getComponentById")
	@ApiBaseSiteIdParam
	...
	@ResponseBody
	@ApiOperation(value = "Find component data by id(s)", notes = "Given a list of component identifiers, return cms component data.", nickname = "findComponentsByIds")
	@ApiBaseSiteIdParam
