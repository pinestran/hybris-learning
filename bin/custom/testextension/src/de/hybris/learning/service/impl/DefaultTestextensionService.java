...
public class DefaultTestextensionService implements TestextensionService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTestextensionService.class);
	...
	{
		return DefaultTestextensionService.class.getResourceAsStream("/testextension/sap-hybris-platform.png");
	}
