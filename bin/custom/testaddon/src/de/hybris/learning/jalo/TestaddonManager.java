...
import de.hybris.learning.constants.TestaddonConstants;



/**
 * This is the extension manager of the Testaddon extension.
 */
public class TestaddonManager extends GeneratedTestaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TestaddonManager.class.getName());
	 ...
	 */
	public static TestaddonManager getInstance()
	{
		return (TestaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TestaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TestaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TestaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TestaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TestaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
